...
import 'predictor_v1_model.dart';
export 'predictor_v1_model.dart';

class PredictorV1Widget extends StatefulWidget {
  const PredictorV1Widget({
    super.key,
  ...
  @override
  State<PredictorV1Widget> createState() => _PredictorV1WidgetState();
}

class _PredictorV1WidgetState extends State<PredictorV1Widget> {
  late PredictorV1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PredictorV1Model());
                                                            ...
                                                            onPressed: ((pageoneCheckIfTheyvePlayedPredictorThisWeekResponse
                                                                ...
                                                                : () async {
                                                                    if (getCurrentTimestamp
                                                                        ...
                                                                        (containerPredictorNextGameResponse.jsonBody.toList().map<BLESSfixtureStruct?>(BLESSfixtureStruct.maybeFromMap).toList()
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return WebViewAware(
                                                                      child:
                                                                          AlertDialog(
                                                                        title: Text(
                                                                            'No ${FFLibraryValues().NicknamePlural} Account'),
                                                                        content:
                                                                ...
                                                                if (getCurrentTimestamp
                                                                  ...
                                                                  _model.apiResultsia =
                                                                    ...
                                                                    scorerName:
                                                                        valueOrDefault<
                                                                            String>(
                                                                      ((columnPlayerNewPredictorResponse.jsonBody.toList().map<PlayerStruct?>(PlayerStruct.maybeFromMap).toList() as Iterable<PlayerStruct?>)
                                                                              .withoutNulls
                                                                              ?.elementAtOrNull(_model.telfordPlayerIndexSelected))
                                                                          ?.playerName,
                                                                      'Player Name',
                                                                  ...
                                                                  if ((_model
                                                                    ...
                                                                    _model.apiResult788 =
                                                                      ...
                                                                      objectIdToAdd: (containerPredictorNextGameResponse
                                                                              .jsonBody
                                                                              .toList()
                                                                              .map<BLESSfixtureStruct?>(BLESSfixtureStruct.maybeFromMap)
                                                                              .toList() as Iterable<BLESSfixtureStruct?>)
