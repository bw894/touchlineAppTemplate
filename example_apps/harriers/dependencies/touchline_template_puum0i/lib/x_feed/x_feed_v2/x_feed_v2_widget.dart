...
import 'x_feed_v2_model.dart';
export 'x_feed_v2_model.dart';

class XFeedV2Widget extends StatefulWidget {
  const XFeedV2Widget({super.key});

  @override
  State<XFeedV2Widget> createState() => _XFeedV2WidgetState();
}

class _XFeedV2WidgetState extends State<XFeedV2Widget> {
  late XFeedV2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XFeedV2Model());
