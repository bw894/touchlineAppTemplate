...
import 'x_feed_v4_model.dart';
export 'x_feed_v4_model.dart';

class XFeedV4Widget extends StatefulWidget {
  const XFeedV4Widget({super.key});

  @override
  State<XFeedV4Widget> createState() => _XFeedV4WidgetState();
}

class _XFeedV4WidgetState extends State<XFeedV4Widget> {
  late XFeedV4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XFeedV4Model());
