...
import 'wordpress_news_feed_v2_model.dart';
export 'wordpress_news_feed_v2_model.dart';

class WordpressNewsFeedV2Widget extends StatefulWidget {
  const WordpressNewsFeedV2Widget({
    super.key,
  ...
  @override
  State<WordpressNewsFeedV2Widget> createState() =>
      _WordpressNewsFeedV2WidgetState();
}

class _WordpressNewsFeedV2WidgetState extends State<WordpressNewsFeedV2Widget> {
  late WordpressNewsFeedV2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WordpressNewsFeedV2Model());
