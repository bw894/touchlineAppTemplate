...
import 'squad_hub_slider_v4_model.dart';
export 'squad_hub_slider_v4_model.dart';

class SquadHubSliderV4Widget extends StatefulWidget {
  const SquadHubSliderV4Widget({
    super.key,
    required this.tapAction,
    String? sort,
    bool? squadNumbers,
  })  : this.sort = sort ?? 'number',
        this.squadNumbers = squadNumbers ?? true;
  ...
  @override
  State<SquadHubSliderV4Widget> createState() => _SquadHubSliderV4WidgetState();
}

class _SquadHubSliderV4WidgetState extends State<SquadHubSliderV4Widget> {
  late SquadHubSliderV4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SquadHubSliderV4Model());
