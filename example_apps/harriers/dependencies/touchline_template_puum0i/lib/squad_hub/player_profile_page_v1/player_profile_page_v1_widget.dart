...
import 'player_profile_page_v1_model.dart';
export 'player_profile_page_v1_model.dart';

class PlayerProfilePageV1Widget extends StatefulWidget {
  const PlayerProfilePageV1Widget({
    super.key,
    Color? homeKitColour,
    Color? awayKitColour,
  ...
  @override
  State<PlayerProfilePageV1Widget> createState() =>
      _PlayerProfilePageV1WidgetState();
}

class _PlayerProfilePageV1WidgetState extends State<PlayerProfilePageV1Widget> {
  late PlayerProfilePageV1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerProfilePageV1Model());
