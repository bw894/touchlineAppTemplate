...
import 'player_profile_page_v3_model.dart';
export 'player_profile_page_v3_model.dart';

class PlayerProfilePageV3Widget extends StatefulWidget {
  const PlayerProfilePageV3Widget({
    super.key,
    required this.playerObjectId,
    Color? homeKitColour,
    Color? awayKitColour,
  })  : this.homeKitColour = homeKitColour ?? const Color(0xFFEAB008),
        this.awayKitColour = awayKitColour ?? const Color(0xFFEAB008);
  ...
  @override
  State<PlayerProfilePageV3Widget> createState() =>
      _PlayerProfilePageV3WidgetState();
}

class _PlayerProfilePageV3WidgetState extends State<PlayerProfilePageV3Widget> {
  late PlayerProfilePageV3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerProfilePageV3Model());
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  PlayerStruct.maybeFromMap(containerGetSpecificPlayerResponse.jsonBody)
                                                                              ?.homeSponsor ==
                                                                          PlayerStruct.maybeFromMap(containerGetSpecificPlayerResponse.jsonBody)
                                                                              ?.awaySponsor
                                                                      ? 'HOME & AWAY KIT'
