...
import 'player_profile_page_v2_model.dart';
export 'player_profile_page_v2_model.dart';

class PlayerProfilePageV2Widget extends StatefulWidget {
  const PlayerProfilePageV2Widget({
    super.key,
    Color? homeKitColour,
    Color? awayKitColour,
  ...
  @override
  State<PlayerProfilePageV2Widget> createState() =>
      _PlayerProfilePageV2WidgetState();
}

class _PlayerProfilePageV2WidgetState extends State<PlayerProfilePageV2Widget> {
  late PlayerProfilePageV2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerProfilePageV2Model());
