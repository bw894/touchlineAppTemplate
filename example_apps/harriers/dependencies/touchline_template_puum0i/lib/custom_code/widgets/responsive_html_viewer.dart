...
class ResponsiveHtmlViewer extends StatefulWidget {
  const ResponsiveHtmlViewer({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<ResponsiveHtmlViewer> createState() => _ResponsiveHtmlViewerState();
}

class _ResponsiveHtmlViewerState extends State<ResponsiveHtmlViewer> {
// Extract YouTube video ID from URL
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      // Set a reasonable fixed height - this is key!
      height: widget.height ?? screenSize.height * 0.8,
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(8),
      ),
      // This is the important part - we're explicitly making this container scrollable
      child: SingleChildScrollView(
        // This physics allows natural scrolling
          ...
          child: HtmlWidget(
            ...
            customStylesBuilder: (element) {
              ...
              if (element.localName == 'p') {
                return {
                  'margin': '0 0 24px 0', // Top Right Bottom Left
                  'line-height': '1.6',
                };
              }
                    ...
                    if (videoId != null) {
                      ...
                      return Container(
                        margin: const EdgeInsets.symmetric(
                            vertical: 24), // Add more margin here
