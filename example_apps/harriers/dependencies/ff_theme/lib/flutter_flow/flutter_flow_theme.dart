...
abstract class FlutterFlowTheme {
  ...
  late Color predictorRed;
  late Color predictorOrange;
  late Color predictorGreen;
  late Color shopBorder;
  late Color shopDark;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFEB2D2E);
  late Color secondary = const Color(0xFF222222);
  ...
  late Color accent1 = const Color(0xFFE53B4D);
  ...
  late Color predictorRed = const Color(0xFFEA0007);
  late Color predictorOrange = const Color(0xFFF78900);
  late Color predictorGreen = const Color(0xFF007504);
  late Color shopBorder = const Color(0xFFD9D9D9);
  late Color shopDark = const Color(0xFF212121);
}
