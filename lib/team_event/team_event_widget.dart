                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, playersIndex) {
                                      ...
                                      return wrapWithModel(
                                        model:
                                            _model.rsvpComponentModels.getModel(
                                        ...
                                        child: RsvpComponentWidget(
                                          ...
                                          playerName: playersItem.playerName,
                                          isRSVPYes: TeamEventStruct.maybeFromMap(
                                                  pageContainerGetTeamEventByIDResponse
                                                      .jsonBody)
                                              ?.rsvpYES
                                              .contains(playersItem),
                                          isRSVPNo: TeamEventStruct.maybeFromMap(
                                                  pageContainerGetTeamEventByIDResponse
                                                      .jsonBody)
                                              ?.rsvpNO
                                              .contains(playersItem),
                                          isRSVPUnsure:
                                              TeamEventStruct.maybeFromMap(
                                                  ...
                                                  ?.rsvpUNSURE
                                                  .contains(playersItem),
                                          playerObjectId: playersItem.objectId,
                                          eventObjectId: widget.objectId!,
                                        ),
                                      );
                                    },
