...
import 'games_page_v1_model.dart';
export 'games_page_v1_model.dart';

class GamesPageV1Widget extends StatefulWidget {
  const GamesPageV1Widget({
    super.key,
  ...
  @override
  State<GamesPageV1Widget> createState() => _GamesPageV1WidgetState();
}

class _GamesPageV1WidgetState extends State<GamesPageV1Widget>
    with TickerProviderStateMixin {
  late GamesPageV1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GamesPageV1Model());
