...
import 'squad_hub_slider_v1_model.dart';
export 'squad_hub_slider_v1_model.dart';

class SquadHubSliderV1Widget extends StatefulWidget {
  const SquadHubSliderV1Widget({
    super.key,
  ...
  @override
  State<SquadHubSliderV1Widget> createState() => _SquadHubSliderV1WidgetState();
}

class _SquadHubSliderV1WidgetState extends State<SquadHubSliderV1Widget> {
  late SquadHubSliderV1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SquadHubSliderV1Model());
