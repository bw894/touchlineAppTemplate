...
/// A horizontal tab bar rendered as styled buttons.
///
/// Supports scrollable and fixed layouts, toggle-button style, animated
/// selection transitions, and per-tab border/colour customisation.
///
/// Ported from [FlutterFlowButtonTabBar] in [flutter_flow_button_tabbar.dart].
