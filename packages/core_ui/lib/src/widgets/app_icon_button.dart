...
/// A square icon button with hover, focus, disabled, and loading states.
///
/// Ported from [FlutterFlowIconButton] in [flutter_flow_icon_button.dart].
...
class _AppIconButtonState extends State<AppIconButton> {
  ...
  void _updateIcon() {
    if (widget.icon is FaIcon) {
      final fa = widget.icon as FaIcon;
      effectiveIcon = FaIcon(fa.icon, size: fa.size);
      iconSize = fa.size;
      iconColor = fa.color;
    } else {
      final ic = widget.icon as Icon;
      effectiveIcon = Icon(ic.icon, size: ic.size);
      iconSize = ic.size;
      iconColor = ic.color;
    }
  }
