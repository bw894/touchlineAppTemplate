...
// NOTE: The `colour` field is stored as a CSS color String in the pure-Dart
// data layer. Flutter UI layers should convert to Color via fromCssColor().
class SponsorshipDealsStruct extends BaseStruct {
  ...
  // "colour" field — stored as CSS color string (e.g. '#FF0000').
  String? _colour;
